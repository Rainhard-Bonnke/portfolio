...
function SocialIcon({ href, label, children }) {
  if (!href) {
    return (
      <span className="social-link disabled" aria-label={`${label} (not linked)`} title="Link not set">
        {children}
      </span>
    )
  }
...
export default function Contact() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await fetch(SITE.formScriptUrl, {
        method: 'POST',
      ...
      <div className="container contact-grid">
        <div className="contact-info">
          ...
          <p className="section-intro">
            Open to full-stack developer roles, freelance builds, and collaborations. Reach out
            via the form or the channels below.
          </p>
          ...
          <div className="social-icons">
            <SocialIcon href={SITE.whatsapp} label="WhatsApp">
          ...
          <a href={SITE.cvPath} download className="btn btn-primary contact-cv">
            Download CV
          </a>
        </div>
